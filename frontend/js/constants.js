const contractAddress = "0x9BE30bF5f124044339B11b7cdC74500446d662cb"; // Replace with your own contract address
const chain = 'polygon'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Rhino Family NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Rhino Family NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://www.youtube.com/channel/UC9jGVYqXC9sJ0OwC8h2WsFA"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
